    ...
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-white/8 bg-background/95 pt-[72px] xl:block">
      <div className="flex h-full flex-col px-4 py-6">
        ...
        <div className="mt-auto space-y-3">
          <button className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-primary-container text-sm font-bold text-white transition hover:bg-primary-container/90 active:scale-95">
